...
public class Game
{
	...
	ArrayList<ChessPiece> blackPieces = new ArrayList<>(); // List of black pieces
...
//		//fillDebug();
	...
	private void fillDebug(){
		whitePieces.add(ChessPieceFactory.getInstance(EnumPieceColor.WHITE, 5, 5, EnumPieceType.ROOK));
		//whitePieces.add(new Rook(EnumPieceColor.WHITE, 5, 5));
		blackPieces.add(new Rook(EnumPieceColor.BLACK, 5, 3));
	}
